    ...
    protected byte[] MergeBuffer(
      ...
      if (count1 > len1) {
        throw new IndexOutOfRangeException(String.Format (
          "Copy count of {0} > {1} within first buffer",
          count1,
          len1
        ));
      }
      ...
      if (count2 > len2) {
        throw new IndexOutOfRangeException(String.Format (
          "Copy count of {0} > {1} within second buffer",
          count2,
          len2
        ));
      }
      ...
      if (pos1 > count1) {
        throw new IndexOutOfRangeException(String.Format (
          "Start position of {0} > {1} the first buffer count",
          pos1,
          count1
        ));
      }
      ...
      if (pos2 > count2) {
        throw new IndexOutOfRangeException(String.Format (
          "Start position of {0} > {1} the second buffer count",
          pos2,
          count2
        ));
      }
